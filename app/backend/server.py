...
listings: list[dict[str, Any]] = [
    ...
    {
        "id": "lst-11",
        "title": "Pastel Pink Oversized Hoodie",
        "description": "Ultra-soft oversized hoodie in blush pink, perfect for cozy days or casual outings. Barely worn.",
        "category": "Tops",
        "brand": "H&M",
        "size": "L",
        "condition": "Like New",
        "estimated_value": 2800,
        "images": ["https://images.unsplash.com/photo-1556821840-3a63f15732ce?w=900&h=1100&fit=crop"],
    ...
    },
    {
        ...
        "description": "Timeless white oxford button-down, slim fit with subtle texture. Office-ready and versatile.",
        "category": "Tops",
        "brand": "Arrow",
        "size": "M",
        "condition": "Excellent",
        "estimated_value": 1900,
        "images": ["https://images.unsplash.com/photo-1598032895397-b9472444bf93?w=900&h=1100&fit=crop"],
    ...
    },
    {
        ...
        "description": "Flowy palazzo pants in earthy beige, great for summer styling or beach days. Elastic waist.",
        "category": "Bottoms",
        "brand": "Mango",
        "size": "S",
        "condition": "Good",
        "estimated_value": 3200,
        "images": ["https://images.unsplash.com/photo-1509551388413-e18d0ac5d495?w=900&h=1100&fit=crop"],
    ...
    },
    {
        ...
        "description": "Genuine leather crossbody with adjustable strap and gold hardware. Fits phone, wallet, and keys.",
        "category": "Accessories",
        "brand": "Hidesign",
        "size": "One Size",
        "condition": "Excellent",
        "estimated_value": 5500,
        "images": ["https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=900&h=1100&fit=crop"],
    ...
    },
    {
        ...
        "description": "Iconic high-top in classic black, lightly worn with clean soles. Pairs well with everything.",
        "category": "Shoes",
        "brand": "Converse",
        "size": "8",
        "condition": "Like New",
        "estimated_value": 3800,
        "images": ["https://images.unsplash.com/photo-1607522370275-f6fd0c8a5d46?w=900&h=1100&fit=crop"],
        "location": "Surat, India",
        "owner_id": "user-15",
        "owner_name": "Rohan Patel",
        "created_at": now(),
    },
    {
        "id": "lst-16",
        "title": "Silk Wrap Blouse",
        "description": "Elegant silk-feel wrap blouse in dusty rose. Flattering fit for work or evening occasions.",
        "category": "Tops",
        "brand": "Zara",
        "size": "M",
        "condition": "Excellent",
        "estimated_value": 2400,
        "images": ["https://images.unsplash.com/photo-1485518882345-15568b007407?w=900&h=1100&fit=crop"],
        "location": "Bhopal, India",
        "owner_id": "user-16",
        "owner_name": "Divya Mishra",
        "created_at": now(),
    },
    {
        "id": "lst-17",
        "title": "Slim Fit Dark Indigo Jeans",
        "description": "Dark indigo slim jeans with slight stretch, barely worn. Sharp look for casual or smart-casual outfits.",
        "category": "Bottoms",
        "brand": "Levi's",
        "size": "32",
        "condition": "Good",
        "estimated_value": 3600,
        "images": ["https://images.unsplash.com/photo-1542272604-787c3835535d?w=900&h=1100&fit=crop"],
    ...
    {
        "id": "lst-18",
        "title": "Flowy Boho Maxi Dress",
        "description": "Effortlessly beautiful maxi dress with floral print and tiered skirt. Perfect for summer festivals.",
        "category": "Dresses",
        "brand": "ASOS",
        "size": "M",
        "condition": "Like New",
        "estimated_value": 3300,
        "images": ["https://images.unsplash.com/photo-1496217590455-aa63a8350eea?w=900&h=1100&fit=crop"],
    ...
    },
    {
        ...
        "description": "Military-inspired olive bomber with ribbed cuffs. Lightweight and perfect for transitional weather.",
        "category": "Outerwear",
        "brand": "Pull&Bear",
        "size": "L",
        "condition": "Good",
        "estimated_value": 4200,
        "images": ["https://images.unsplash.com/photo-1551537482-f2075a1d41f2?w=900&h=1100&fit=crop"],
        "location": "Kochi, India",
        "owner_id": "user-13",
        "owner_name": "Anjali Nair",
        "created_at": now(),
    },
    {
        ...
        "description": "Lightweight Nike running shoes in white/grey. High cushion sole, great for running or daily wear.",
        "category": "Shoes",
        "brand": "Nike",
        "size": "10",
        "condition": "Excellent",
        "estimated_value": 5200,
        "images": ["https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=900&h=1100&fit=crop"],
        "location": "Noida, India",
        "owner_id": "user-11",
        "owner_name": "Priya Singh",
        "created_at": now(),
    },
    {
        ...
        "description": "Delicate hand-embroidered cotton kurti in white with mirror work. Elegant yet comfortable for daily wear.",
        "category": "Tops",
        "brand": "Biba",
        "size": "XL",
        "condition": "Excellent",
    ...
    },
    {
        ...
        "description": "Warm tobacco-brown corduroy trousers with wide silhouette. A statement piece for autumn dressing.",
        "category": "Bottoms",
        "brand": "H&M",
        "size": "M",
        "condition": "Like New",
        "estimated_value": 2900,
        "images": ["https://images.unsplash.com/photo-1539109136881-3be0616acf4b?w=900&h=1100&fit=crop"],
        "location": "Surat, India",
        "owner_id": "user-15",
        "owner_name": "Rohan Patel",
        "created_at": now(),
    ...
    {
        "id": "lst-23",
        "title": "Off-Shoulder Mini Dress",
        "description": "Chic off-shoulder mini in cream with ruffled neckline. Dressed up with heels or down with sneakers.",
        "category": "Dresses",
        "brand": "Zara",
        "size": "S",
        "condition": "Good",
        "estimated_value": 2600,
        "images": ["https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?w=900&h=1100&fit=crop"],
        "location": "Chandigarh, India",
        "owner_id": "user-12",
        "owner_name": "Arjun Verma",
        "created_at": now(),
    },
    {
        ...
        "description": "Packable puffer jacket in cobalt blue. Warm without bulk, great for travel and cool evenings.",
        "category": "Outerwear",
        "brand": "The North Face",
        "size": "M",
        "condition": "Good",
        "estimated_value": 6500,
        "images": ["https://images.unsplash.com/photo-1539185441755-769473a23570?w=900&h=1100&fit=crop"],
        "location": "Delhi, India",
        "owner_id": "user-19",
    ...
    },
    {
        ...
        "description": "Classic leather Chelsea boots in cognac with elastic side panels. Worn twice, minimal creasing.",
        "category": "Shoes",
        "brand": "Clarks",
        "size": "7",
        "condition": "Excellent",
        "estimated_value": 6800,
        "images": ["https://images.unsplash.com/photo-1543163521-1bf539c55dd2?w=900&h=1100&fit=crop"],
        "location": "Mumbai, India",
        "owner_id": "user-20",
    ...
    },
    {
        ...
        "description": "Premium high-waist leggings with four-way stretch and side pocket. Squat-proof and moisture-wicking.",
        "category": "Activewear",
        "brand": "Lululemon",
        "size": "M",
        "condition": "Like New",
        "estimated_value": 4500,
        "images": ["https://images.unsplash.com/photo-1506629082955-511b1aa562c8?w=900&h=1100&fit=crop"],
        "location": "Bengaluru, India",
        "owner_id": "user-21",
        "owner_name": "Deepa Krishnan",
        "created_at": now(),
    },
    {
        "id": "lst-27",
        "title": "Chunky Knit Cardigan",
        "description": "Cozy oversized cardigan in oatmeal. Deep pockets and a relaxed fit for layering or lounging.",
        "category": "Tops",
        "brand": "Uniqlo",
        "size": "L",
        "condition": "Excellent",
        "estimated_value": 3100,
        "images": ["https://images.unsplash.com/photo-1576566588028-4147f3842f27?w=900&h=1100&fit=crop"],
        "location": "Chennai, India",
        "owner_id": "user-22",
        "owner_name": "Ramya Iyer",
        "created_at": now(),
    },
    {
        "id": "lst-28",
        "title": "Vintage Round Sunglasses",
        "description": "Retro round sunglasses with gold metal frames and amber lenses. UV400 protection, comes with case.",
        "category": "Accessories",
        "brand": "Ray-Ban",
        "size": "One Size",
        "condition": "Good",
        "estimated_value": 4200,
        "images": ["https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?w=900&h=1100&fit=crop"],
        "location": "Pune, India",
        "owner_id": "user-23",
    ...
    },
    {
        ...
        "description": "Large structured tote in tan canvas with leather handles and zip closure. Laptop-friendly interior.",
        "category": "Accessories",
        "brand": "Fossil",
        "size": "One Size",
        "condition": "Excellent",
        "estimated_value": 5900,
        "images": ["https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=900&h=1100&fit=crop"],
        "location": "Hyderabad, India",
        "owner_id": "user-24",
        "owner_name": "Rahul Reddy",
        "created_at": now(),
    },
    {
        "id": "lst-30",
        "title": "Men's Formal Blazer",
        "description": "Tailored single-breasted blazer in charcoal grey. Two-button, fully lined with working button cuffs.",
        "category": "Formal",
        "brand": "Van Heusen",
        "size": "40",
        "condition": "Good",
        "estimated_value": 7500,
        "images": ["https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=900&h=1100&fit=crop"],
        "location": "Jaipur, India",
        "owner_id": "user-25",
        "owner_name": "Sameer Gupta",
        "created_at": now(),
    },
]
